...
public class JwtUtil {
    ...
    public String generateToken(Long userId, String nic, String role, String fullName) {
    ...
    public Boolean validateToken(String token, UserDetails userDetails) {
        final String nic = extractNic(token);
        return (nic.equals(userDetails.getUsername()) && !isTokenExpired(token));
    }
}
