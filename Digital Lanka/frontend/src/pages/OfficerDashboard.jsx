...
import { Shield, Search, User, MapPin, Calendar, FileText, AlertTriangle, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', maxWidth: '1000px', margin: '0 auto' }}>
      ...
      <div className="card" style={{ display: 'flex', alignItems: 'center', gap: '1.5rem', padding: '1.5rem 2rem' }}>
        <div className="placeholder-icon-wrapper" style={{ margin: 0, color: 'var(--accent-cyan)', borderColor: 'rgba(14, 165, 233, 0.2)' }}>
          <Shield size={36} />
        </div>
        <div>
          <h2 style={{ fontSize: '1.5rem', fontWeight: 800 }}>Officer Portal</h2>
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', marginTop: '0.15rem' }}>
            Logged in as: <strong style={{ color: 'var(--accent-cyan)' }}>{authState.fullName}</strong> ({authState.email})
          </p>
        </div>
      </div>
